...
async function generateTokensAndReturnUser(user) {
...
if (AUTH_STRATEGY === 'pythagora_oauth') {
    router.post('/oauth/exchange', async (req, res) => {
        ...
        try {
            ...
            const tokenSet = await client.callback(redirectUri, { code: code });
...
router.post('/logout', requireUser(ALL_ROLES), async (req, res) => {
    try {
