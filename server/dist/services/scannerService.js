...
import FileBaseline from '../models/FileBaseline';
 ...
 */
async function scanDirectory(dirPath, includeSubdirectories, results) {
    try {
 ...
 */
function calculateRiskLevel(changeType, filePath) {
 ...
 */
export async function createBaseline(scanPath, includeSubdirectories) {
    try {
